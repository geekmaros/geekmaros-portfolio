<template>
  <section class="bg-regal-purple h-screen py-8 px-5  sm:py-20 sm:px-40">
    ...
    <a href="mailto:razicruz@gmail.com" class="focus:outline-none">
      <button
        class="getintouch z-10 relative flex items-center text-white focus:outline-none mt-12 hover:bg-regal-purple rounded border border-regal-blue px-2 py-2 sm:px-10 bg-transparent font-hairline font-medium"
      >
        Get In Touch
