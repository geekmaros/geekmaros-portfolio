    ...
    >
      ...
      >
        ...
        <p
          ...
          class="project-summary mt-5 text-base flex flex-wrap tracking-wider z-10 text-justify md:text-right bg-aside-purple p-5 lg:p-8 cursor-pointer shadow-md rounded-md"
        >
          {{ tib.summary }}
        </p>
        <div
